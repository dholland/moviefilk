/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cba7a23045bbc2ae56a1d5ea5883b0ac)
// Runtime types generated with workerd@1.20260421.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "KramerVoiceAgent";
	}
	interface Env {
		AI: Ai;
		KRAMER_TTS_MODE: "http";
		KRAMER_TTS_URL: "http://50.40.234.251:60069/speak";
		ANTHROPIC_API_KEY: string;
		ELEVENLABS_API_KEY: string;
		OPENAI_API_KEY: string;
		KramerVoiceAgent: DurableObjectNamespace<import("./src/server").KramerVoiceAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KRAMER_TTS_MODE" | "KRAMER_TTS_URL" | "ANTHROPIC_API_KEY" | "ELEVENLABS_API_KEY" | "OPENAI_API_KEY">> {}
}
